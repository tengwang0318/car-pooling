...
def parse_solution(data):
    ...
    for data_ in data[:-1]:
        ...
        text = "\n".join([x_text, y_text, z_text]) + f"gap: {data_['gap']}, objective value: {data_['objective_value']}"
...
def generate_prompt(previous_solutions, model_data, is_inference=False, is_random=False, ratio=0):
...
def generate_dataset(path="/Users/code/simulator/lp",
                     is_from_gurobi=True,
                     train_outfile="/Users/code/simulator/train/train.csv",
                     valid_outfile="/Users/code/simulator/valid/valid.csv",
                     test_outfile="/Users/code/simulator/test/test.csv"):
